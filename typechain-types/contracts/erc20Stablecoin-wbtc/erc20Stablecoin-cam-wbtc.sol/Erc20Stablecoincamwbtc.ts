...
export interface Erc20StablecoincamwbtcInterface extends utils.Interface {
  functions: {
...
export interface Erc20Stablecoincamwbtc extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Erc20StablecoincamwbtcInterface;
