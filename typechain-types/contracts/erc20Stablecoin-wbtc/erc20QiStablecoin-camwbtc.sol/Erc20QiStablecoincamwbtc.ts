...
export interface Erc20QiStablecoincamwbtcInterface extends utils.Interface {
  functions: {
...
export interface Erc20QiStablecoincamwbtc extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Erc20QiStablecoincamwbtcInterface;
