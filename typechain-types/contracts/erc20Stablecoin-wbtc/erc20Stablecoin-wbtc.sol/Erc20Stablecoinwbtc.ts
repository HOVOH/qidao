...
export interface Erc20StablecoinwbtcInterface extends utils.Interface {
  functions: {
...
export interface Erc20Stablecoinwbtc extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Erc20StablecoinwbtcInterface;
