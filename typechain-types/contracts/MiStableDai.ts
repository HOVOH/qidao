...
export interface MiStableDaiInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "daiRate", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "daiRate", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setMimaticRatePerUSDC",
    data: BytesLike
  ): Result;
...
export interface MiStableDai extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MiStableDaiInterface;
  ...
  functions: {
    ...
    daiRate(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    daiRate(overrides?: CallOverrides): Promise<PopulatedTransaction>;
