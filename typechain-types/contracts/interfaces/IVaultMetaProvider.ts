...
export interface IVaultMetaProviderInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "getBaseURI" | "getTokenURI"
  ): FunctionFragment;
...
export interface IVaultMetaProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IVaultMetaProviderInterface;
